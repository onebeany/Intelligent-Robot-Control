...
set(MSG_I_FLAGS "-Ibeginner_tutorials:/home/onebean/catkin_ws/src/beginner_tutorials/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/onebean/catkin_ws/src/beginner_tutorials/msg/MyMessage.msg" NAME_WE)
add_custom_target(_beginner_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "beginner_tutorials" "/home/onebean/catkin_ws/src/beginner_tutorials/msg/MyMessage.msg" ""
)
...
_generate_msg_cpp(beginner_tutorials
  "/home/onebean/catkin_ws/src/beginner_tutorials/msg/MyMessage.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/beginner_tutorials)
  install(CODE "execute_process(COMMAND \"/home/onebean/miniconda3/envs/IRC/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/beginner_tutorials\")")
  # install generated code
  install(
